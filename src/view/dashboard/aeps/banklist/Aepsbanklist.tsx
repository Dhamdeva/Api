        ...
        <div className="container-fliud">
            <div className="row">
                ...
                <div className="col-md-5">
                        ...
                        <div className="col-md-7">
                            <a className="left" href="/aepsministatementaeps"><i className="fa-solid fa-arrow-left-long"></i>Mini Statement</a>
                            <a className="right" href="/aepswithdrawltransaction">Withdrawl transaction status<i className="fa-solid fa-arrow-right-long"></i></a> 
                        </div>
            </div>
        </div>
    )
