...
export function Aepsaadharpayaeps(){
    return(
        <div className="container-fliud">
            <div className="row">
                ...
                <div className="col-md-5">
                        ...
                        <div className="col-md-7">
                            <a className="left" href="/aepsaadharpay"><i className="fa-solid fa-arrow-left-long"></i>Aadhar Pay</a>
                            <a className="right" href="/aepsaadharpaytransaction">Aadhar pay transaction status query<i className="fa-solid fa-arrow-right-long"></i></a> 
                        </div>
            </div>
        </div>
    )
