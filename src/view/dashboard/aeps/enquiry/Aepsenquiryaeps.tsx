...
export function Aepsenquiryaeps(){
    return(
        <div className="container-fliud">
            <div className="row">
                ...
                <div className="col-md-5">
                        ...
                        <div className="col-md-7">
                            <a className="left" href="/aepsenquiry"><i className="fa-solid fa-arrow-left-long"></i>Enquiry</a>
                            <a className="right" href="/aepswithdrawl">Withdrawl<i className="fa-solid fa-arrow-right-long"></i></a> 
                        </div>
            </div>
        </div>
    )
