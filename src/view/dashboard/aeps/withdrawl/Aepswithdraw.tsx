        ...
        <div className="container-fliud">
            <div className="row">
                ...
                <div className="col-md-5">
                        ...
                        <div className="col-md-7">
                            <a className="left" href="/aepswithdrawl"><i className="fa-solid fa-arrow-left-long"></i>Withdrawl</a>
                            <a className="right" href="/aepsministatement">Ministatement<i className="fa-solid fa-arrow-right-long"></i></a> 
                        </div>
            </div>
        </div>
    )
