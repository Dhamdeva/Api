...
export function Aepswithdrawthreeway(){
    return(
        <div className="container-fliud">
            <div className="row">
                <div className="col-md-7">
                    <Head
                    h2={"Withdraw Three way"}
                ...
                <div className="col-md-5">
                        ...
                        <div className="col-md-7">
                            <a className="left" href="/aepswithdrawthreewayrecon"><i className="fa-solid fa-arrow-left-long"></i>Withdrawl Three Way Recon</a>
                            <a className="right" href="/aepsaadharpay">Aadhar Pay<i className="fa-solid fa-arrow-right-long"></i></a> 
                        </div>
            </div>
        </div>
    )
