...
export function Language(this: any, props:any){
    ...
    return(
        ...
        <ul className="nav nav-pills mb-3 row justify-content-around" id="pills-tab" role="tablist">
            <li className="nav-item col-md-1  col-4" role="presentation">
            ...
            {/* <li className="nav-item dropdown col-md-1">
            <a className="nav-link dropdown-toggle"  role="button" >Transaction</a>
            <ul className="dropdown-menu">
