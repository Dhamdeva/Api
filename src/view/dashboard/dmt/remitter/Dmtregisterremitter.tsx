...
export function Dmtregisterremitter(){
    return(
        <div className="container-fluid p-0">
            <div className="row">
                <div className="col-sm-7">
                    <Head
                    h2={"Register Remitter"}
                ...
                <div className="col-md-7">
                    <a className="left" href="/dmtqueryremitter"><i className="fa-solid fa-arrow-left-long"></i>Query Remitter</a>
                    <a className="right" href="/dmtbeneficiary">Beneficiary<i className="fa-solid fa-arrow-right-long"></i></a> 
                </div>
                </div>
            </div>
